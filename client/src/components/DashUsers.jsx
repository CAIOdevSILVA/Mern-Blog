...
import { HiCheck, HiMinus, HiOutlineExclamationCircle } from 'react-icons/hi';
...
const DashUsers = () => {
  ...
  const confirmation = currentUser.isAdmin && users.length > 0;
                  ...
                  <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                    ...
                    <Table.Cell>
                      <span className='font-semibold w-full flex justify-center'>
                        {user.isAdmin && <HiCheck  className='w-5 h-5 text-emerald-500'/>}
                        {!user.isAdmin && <HiMinus  className='w-5 h-5 text-red-300'/>}
                      </span>
                    </Table.Cell>
                    <Table.Cell>
                      <span 
